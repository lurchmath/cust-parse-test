...
converter.addConcept( 'prefixfuncinv',   'prefixfuncexpr',   '(inverse prefixfuncexpr)' )
...
latex.addNotation( 'multiplication',  'A\\ast B' )
...
latex.addNotation( 'implication',     'A\\Rarr B' )
latex.addNotation( 'implication',     'A\\rArr B' )
latex.addNotation( 'implication',     'B\\Leftarrow A' )
latex.addNotation( 'implication',     'B\\Larr A' )
latex.addNotation( 'implication',     'B\\lArr A' )
latex.addNotation( 'iff',             'A\\Leftrightarrow B' )
latex.addNotation( 'iff',             'A\\Lrarr B' )
latex.addNotation( 'iff',             'A\\lrArr B' )
...
latex.addNotation( 'complement',      'A ^ { \\complement }' )
...
latex.addNotation( 'prefixfuncinv',   'A ^ { - 1 }' )
...
latex.addNotation( 'divisibility',    '\\vert' )
...
latex.addNotation( 'equivclass',      '\\lbrack A,B\\rbrack' )
latex.addNotation( 'equivclass',      '\\left[A,B\\right]' )
latex.addNotation( 'equivclass',      '\\left\\lbrack A,B\\right\\rbrack' )
latex.addNotation( 'bareequivclass',  '[A]' )
latex.addNotation( 'bareequivclass',  '\\lbrack A\\rbrack' )
latex.addNotation( 'bareequivclass',  '\\left[A\\right]' )
latex.addNotation( 'bareequivclass',  '\\left\\lbrack A\\right\\rbrack' )
latex.addNotation( 'eqmodclass',      '[A, \\equiv _ B]' )
latex.addNotation( 'eqmodclass',      '\\lbrack A, \\equiv _ B\\rbrack' )
latex.addNotation( 'eqmodclass',      '\\left[A, \\equiv _ B\\right]' )
latex.addNotation( 'eqmodclass',      '\\left\\lbrack A, \\equiv _ B\\right\\rbrack' )
